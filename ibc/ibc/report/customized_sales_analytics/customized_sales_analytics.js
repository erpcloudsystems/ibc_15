...
frappe.query_reports["Customized Sales Analytics"] = {
	"filters": [
		{
			fieldname: "tree_type",
			label: __("Tree Type"),
		...
		},
		{
			...
			label: __("From Date"),
			fieldtype: "Date",
			default: frappe.datetime.year_start(2024), // Set to the beginning of 2024
			reqd: 1
		},
		{
			fieldname:"to_date",
			label: __("To Date"),
			fieldtype: "Date",
			default: frappe.datetime.year_end(2024), // Set to the end of 2024
			reqd: 1
		},
		{
			fieldname: "company",
