...
def get_data(filters):
	...
	for b in brand:
		...
		if item_results:
			...
			cogs = (purchase_in_qty_value + frat) - current_value
			added_value = (sales_value) - ((purchase_in_qty_value + frat) - current_value)
			data['opening'] = round(frat,2)
			data['purchase'] = round(purchase_in_qty_value,2)
			data['total_in'] = round(purchase_in_qty_value + frat,2)
			...
			data['added_value/cogs'] = str(round((added_value / cogs))*100) + ' %'
